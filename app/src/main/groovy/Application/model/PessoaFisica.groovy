...
class PessoaFisica extends Pessoa{
    ...
    def inserirDB() {
        def resultado = CandidatosDAO.insertCandidato(nome, sobrenome, email, CPF, data_nascimento, pais, CEP, descricao, competencias, senha )

        return resultado
    }

    def listarTodos() {
        def resultado = CandidatosDAO.selectAllCandidatos()
        return resultado
    }
}
